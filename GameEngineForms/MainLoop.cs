...
namespace GameEngineForms
{
    static class MainLoop
    {
        ...
        {                       
            GameObjects.LoopContainer.Paint += new PaintEventHandler((object sender, PaintEventArgs e) => Render(sender, e));
            Application.Idle += (object sender, EventArgs e) => {
                while (IdelTiming.IsApplicationIdle())
                {
                    ...
                    if (fpsDisplyInterval.ElapsedMilliseconds > 100)
                    {
                        ...
                        $"ScreenSize: {GameObjects.LoopContainer.Width} x {GameObjects.LoopContainer.Height}" +
        ...
        {
            GameObjects.LoopContainer.Refresh();
            GameObjects.FormToRun.Controls.Add(GameObjects.LoopContainer);
        ...
        private static void Render(object sender, PaintEventArgs e)
        {
            ...
            if (GameObjects.UseDrawFunctions)
            { 
